...
call s:h("MatchParen", {"cterm": "NONE", "ctermbg": s:yellow, "ctermfg": s:red}) " The character under the cursor or just before it, if it is a paired bracket, and its match.
